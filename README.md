...
* [WhatIsBitcoin.Cash](https://whatisbitcoin.cash) [\[src\]](https://github.com/minisat0shi/minisatoshi.cash) ⭐ 8 | 🐛 9 | 🌐 HTML | 📅 2026-09-09 - Discover Bitcoin Cash (BCH): a fast, low-cost, decentralized cryptocurrency designed for everyone. Join the freedom revolution!
...
* [Cake Wallet](https://cakewallet.com/) [\[code\]](https://github.com/cake-tech/cake_wallet) ⭐ 1,902 | 🐛 348 | 🌐 Dart | 📅 2026-09-10 [\[apk\]](https://github.com/cake-tech/cake_wallet/releases) ⭐ 1,902 | 🐛 348 | 🌐 Dart | 📅 2026-09-10 - An open source wallet for iOS and Android supporting XMR and other currencies.
* [Stack Wallet](https://stackwallet.com/) [\[code\]](https://github.com/cypherstack/stack_wallet) ⭐ 458 | 🐛 199 | 🌐 Dart | 📅 2026-09-10 - Multicoin wallet with UTXO (coin) control.
* [Coin Wallet](https://coin.space/) [\[code\]](https://github.com/CoinSpace/CoinSpace) ⭐ 458 | 🐛 21 | 🌐 Vue | 📅 2026-09-08 - A self-custodial multicurrency wallet for multiple platforms (iOS and Android).
...
* 🔵 [Paytaca](https://www.paytaca.com/) [\[apk\]](https://github.com/paytaca/paytaca-app/releases) ⭐ 57 | 🐛 7 | 🌐 Vue | 📅 2026-09-11 [\[code\]](https://github.com/paytaca/paytaca-app) ⭐ 57 | 🐛 7 | 🌐 Vue | 📅 2026-09-11 - A mobile wallet for Android, iOS and ChromeOS
* 🔵 [Cashonize](https://github.com/cashonize/cashonize-wallet/tags) ⭐ 21 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-10 [\[code\]](https://github.com/cashonize/cashonize-wallet) ⭐ 21 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-10 - Offering an Android wallet for CashTokens.
...
* [Coin Wallet](https://coin.space/) [\[code\]](https://github.com/CoinSpace/CoinSpace) ⭐ 458 | 🐛 21 | 🌐 Vue | 📅 2026-09-08 - A self-custodial multicurrency wallet for multiple platforms (Windows, macOS and Linux).
...
* 🔵 [Cashonize (quasar)](https://github.com/cashonize/cashonize-wallet/tags) ⭐ 21 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-10 [\[code\]](https://github.com/cashonize/cashonize-wallet) ⭐ 21 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-10 - Cashonize rewrite with Quasar & Vue-js
...
* [Coin Wallet](https://coin.space/) [\[code\]](https://github.com/CoinSpace/CoinSpace) ⭐ 458 | 🐛 21 | 🌐 Vue | 📅 2026-09-08 - A self-custodial multicurrency wallet for multiple platforms (Web and Tor).
* 🔵 [Cashonize](https://cashonize.com/) [\[code\]](https://github.com/cashonize/cashonize-wallet) ⭐ 21 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-10 -  An experimental web wallet for CashTokens.
...
* [Bitcoin.com Paper Wallet](https://paperwallet.bitcoin.com/) [\[code\]](https://github.com/Bitcoin-com/paperwallet.bitcoin.com) ⭐ 100 | 🐛 8 | 🌐 HTML | 📅 2022-02-16 - A fork of the cashaddress.org paper wallet
...
* [Stamps](https://stamps.cash/#/) [\[code\]](https://github.com/harvmaster/CashStamps) ⭐ 6 | 🐛 2 | 🌐 Vue | 📅 2026-09-10 - Create reclaimable BCH wallets
...
* [BasicSwapdex](https://basicswapdex.com) [\[code\]](https://github.com/basicswap/basicswap) ⭐ 323 | 🐛 55 | 🌐 Python | 📅 2026-09-08 - Atomic swap DEX with BitcoinCash support
...
* 🔵 [Bitcoin Cash Explorer](https://explorer.salemkode.com/) [\[code\]](https://github.com/salemkode/explorer) ⭐ 9 | 🐛 11 | 🌐 Vue | 📅 2026-09-09 - A Bitcoin Cash Explorer with CashTokens, by SalemKode.
...
* 🔵 [OpenTokenRegistry](https://otr.cash/) [\[code\]](https://github.com/OpenTokenRegistry/otr.cash) ⭐ 14 | 🐛 8 | 🌐 JavaScript | 📅 2024-09-04 - Community-Verified Token Information
...
* [minisatoshi.cash](https://minisatoshi.cash/ecosystem) [\[code\]](https://github.com/minisat0shi/minisatoshi.cash) ⭐ 8 | 🐛 9 | 🌐 HTML | 📅 2026-09-09 -  Extensive BCH project list with category filters and searching functionality.
...
* 🔵 [Paytaca](https://www.paytaca.com/) [\[apk\]](https://github.com/paytaca/paytaca-app/releases) ⭐ 57 | 🐛 7 | 🌐 Vue | 📅 2026-09-11 [\[code\]](https://github.com/paytaca/paytaca-app) ⭐ 57 | 🐛 7 | 🌐 Vue | 📅 2026-09-11 - A mobile wallet with integrated POS.
...
* [Upgrade History](https://minisatoshi.cash/upgrade-history) [\[src\]](https://github.com/minisat0shi/minisatoshi.cash) ⭐ 8 | 🐛 9 | 🌐 HTML | 📅 2026-09-09 - Full history of Bitcoin (Cash) upgrades since 2009 including future proposals
...
* [Payment Requests Specification (BIP-0070)](https://github.com/bitcoin/bips/blob/master/bip-0070.mediawiki) ⭐ 10,931 | 🐛 57 | 🌐 Wikitext | 📅 2026-09-10 - For dealing with invoice style payments at specific amounts.
...
* 🔵 [bchd](https://bchd.cash/) [\[code\]](https://github.com/gcash/bchd) ⭐ 291 | 🐛 23 | 🌐 Go | 📅 2026-09-10 [\[docs\]](https://github.com/gcash/bchd/tree/master/docs) ⭐ 291 | 🐛 23 | 🌐 Go | 📅 2026-09-10 - alternative implementation written in Go (golang)
...
* 🔵 [Fulcrum](https://fulcrumserver.org) [\[repos\]](https://github.com/cculianu/Fulcrum/) ⭐ 498 | 🐛 63 | 🌐 C++ | 📅 2026-09-05 - A fast & nimble SPV Server for Bitcoin Cash.
...
* 🔵 [mainnet-js](https://mainnet.cash/) [\[code\]](https://github.com/mainnet-cash/mainnet-js) ⭐ 34 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-19 - Typescript library, also available over rest.
...
* [BitcoinCashClient](https://github.com/david-shattuck/BitcoinCashClient) ⭐ 8 | 🐛 0 | 🌐 C# | 📅 2026-09-11 - Simple C# Library for Bitcoin Cash
