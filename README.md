...
* [Cake Wallet](https://cakewallet.com/) [\[code\]](https://github.com/cake-tech/cake_wallet) ⭐ 1,907 | 🐛 345 | 🌐 Dart | 📅 2026-09-14 [\[apk\]](https://github.com/cake-tech/cake_wallet/releases) ⭐ 1,907 | 🐛 345 | 🌐 Dart | 📅 2026-09-14 - An open source wallet for iOS and Android supporting XMR and other currencies.
...
* 🔵 [Cashonize](https://github.com/cashonize/cashonize-wallet/tags) ⭐ 21 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-13 [\[code\]](https://github.com/cashonize/cashonize-wallet) ⭐ 21 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-13 - Offering an Android wallet for CashTokens.
...
* [Coin Wallet](https://coin.space/) [\[code\]](https://github.com/CoinSpace/CoinSpace) ⭐ 459 | 🐛 21 | 🌐 Vue | 📅 2026-09-08 - A self-custodial multicurrency wallet for multiple platforms (Windows, macOS and Linux).
...
* 🔵 [Cashonize (quasar)](https://github.com/cashonize/cashonize-wallet/tags) ⭐ 21 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-13 [\[code\]](https://github.com/cashonize/cashonize-wallet) ⭐ 21 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-13 - Cashonize rewrite with Quasar & Vue-js
...
* [Coin Wallet](https://coin.space/) [\[code\]](https://github.com/CoinSpace/CoinSpace) ⭐ 459 | 🐛 21 | 🌐 Vue | 📅 2026-09-08 - A self-custodial multicurrency wallet for multiple platforms (Web and Tor).
* 🔵 [Cashonize](https://cashonize.com/) [\[code\]](https://github.com/cashonize/cashonize-wallet) ⭐ 21 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-13 -  An experimental web wallet for CashTokens.
...
* [BasicSwapdex](https://basicswapdex.com) [\[code\]](https://github.com/basicswap/basicswap) ⭐ 326 | 🐛 50 | 🌐 Python | 📅 2026-09-12 - Atomic swap DEX with BitcoinCash support
...
* [Payment Requests Specification (BIP-0070)](https://github.com/bitcoin/bips/blob/master/bip-0070.mediawiki) ⭐ 10,937 | 🐛 63 | 🌐 Wikitext | 📅 2026-09-11 - For dealing with invoice style payments at specific amounts.
...
* 🔵 [Libauth](https://libauth.org/) [\[code\]](https://github.com/bitauth/libauth) ⭐ 289 | 🐛 31 | 🌐 TypeScript | 📅 2025-09-19 - an ultra-lightweight, zero-dependency library for Bitcoin Cash and Bitauth applications. (Formerly `bitcoin-ts`.)
