...
* [Cake Wallet](https://cakewallet.com/) [\[code\]](https://github.com/cake-tech/cake_wallet) ⭐ 1,893 | 🐛 336 | 🌐 Dart | 📅 2026-09-04 [\[apk\]](https://github.com/cake-tech/cake_wallet/releases) ⭐ 1,893 | 🐛 336 | 🌐 Dart | 📅 2026-09-04 - An open source wallet for iOS and Android supporting XMR and other currencies.
...
* [Stack Wallet](https://stackwallet.com/) [\[code\]](https://github.com/cypherstack/stack_wallet) ⭐ 456 | 🐛 199 | 🌐 Dart | 📅 2026-09-03 - Multicoin wallet with UTXO (coin) control.
* 🔵 [Electron-Cash](https://electroncash.org) - Android [\[code\]](https://github.com/Electron-Cash/Electron-Cash/tree/master/android) ⭐ 390 | 🐛 439 | 🌐 Python | 📅 2026-08-30 and iOS [\[code\]](https://github.com/Electron-Cash/Electron-Cash/tree/master/ios) ⭐ 390 | 🐛 439 | 🌐 Python | 📅 2026-08-30 versions available with more limited functionality.
* 🔵 [Paytaca](https://www.paytaca.com/) [\[apk\]](https://github.com/paytaca/paytaca-app/releases) ⭐ 57 | 🐛 6 | 🌐 Vue | 📅 2026-09-03 [\[code\]](https://github.com/paytaca/paytaca-app) ⭐ 57 | 🐛 6 | 🌐 Vue | 📅 2026-09-03 - A mobile wallet for Android, iOS and ChromeOS
* 🔵 [Cashonize](https://github.com/cashonize/cashonize-wallet/tags) ⭐ 18 | 🐛 86 | 🌐 TypeScript | 📅 2026-09-03 [\[code\]](https://github.com/cashonize/cashonize-wallet) ⭐ 18 | 🐛 86 | 🌐 TypeScript | 📅 2026-09-03 - Offering an Android wallet for CashTokens.
...
* 🔵 [Electron Cash CashToken](https://electroncash.org) [\[release\]](https://github.com/Electron-Cash/Electron-Cash/releases/tag/4.3.0) ⭐ 390 | 🐛 439 | 🌐 Python | 📅 2026-08-30 [\[code\]](https://github.com/Electron-Cash/Electron-Cash/) ⭐ 390 | 🐛 439 | 🌐 Python | 📅 2026-08-30 - Electron Cash with CashTokens.
* 🔵 [Cashonize (quasar)](https://github.com/cashonize/cashonize-wallet/tags) ⭐ 18 | 🐛 86 | 🌐 TypeScript | 📅 2026-09-03 [\[code\]](https://github.com/cashonize/cashonize-wallet) ⭐ 18 | 🐛 86 | 🌐 TypeScript | 📅 2026-09-03 - Cashonize rewrite with Quasar & Vue-js
...
* 🔵 [Cashonize](https://cashonize.com/) [\[code\]](https://github.com/cashonize/cashonize-wallet) ⭐ 18 | 🐛 86 | 🌐 TypeScript | 📅 2026-09-03 -  An experimental web wallet for CashTokens.
...
* [BasicSwapdex](https://basicswapdex.com) [\[code\]](https://github.com/basicswap/basicswap) ⭐ 323 | 🐛 69 | 🌐 Python | 📅 2026-08-28 - Atomic swap DEX with BitcoinCash support
...
* 🔵 [Paytaca](https://www.paytaca.com/) [\[apk\]](https://github.com/paytaca/paytaca-app/releases) ⭐ 57 | 🐛 6 | 🌐 Vue | 📅 2026-09-03 [\[code\]](https://github.com/paytaca/paytaca-app) ⭐ 57 | 🐛 6 | 🌐 Vue | 📅 2026-09-03 - A mobile wallet with integrated POS.
...
* [Payment Requests Specification (BIP-0070)](https://github.com/bitcoin/bips/blob/master/bip-0070.mediawiki) ⭐ 10,932 | 🐛 55 | 🌐 Wikitext | 📅 2026-09-03 - For dealing with invoice style payments at specific amounts.
...
* 🔵 [Fulcrum](https://fulcrumserver.org) [\[repos\]](https://github.com/cculianu/Fulcrum/) ⭐ 495 | 🐛 63 | 🌐 C++ | 📅 2026-09-03 - A fast & nimble SPV Server for Bitcoin Cash.
