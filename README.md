...
[![Check Links](https://github.com/2qx/awesome-bitcoin-cash/actions/workflows/links.yml/badge.svg)](https://github.com/2qx/awesome-bitcoin-cash/actions/workflows/links.yml) ⭐ 50 | 🐛 20 | 🌐 JavaScript | 📅 2026-08-19 <img src="https://awesome.re/badge.svg" alt="awesome" style="height:20px;border:10;">
...
* [Cake Wallet](https://cakewallet.com/) [\[code\]](https://github.com/cake-tech/cake_wallet) ⭐ 1,863 | 🐛 314 | 🌐 Dart | 📅 2026-08-20 [\[apk\]](https://github.com/cake-tech/cake_wallet/releases) ⭐ 1,863 | 🐛 314 | 🌐 Dart | 📅 2026-08-20 - An open source wallet for iOS and Android supporting XMR and other currencies.
* [Coin Wallet](https://coin.space/) [\[code\]](https://github.com/CoinSpace/CoinSpace) ⭐ 459 | 🐛 21 | 🌐 Vue | 📅 2026-08-20 - A self-custodial multicurrency wallet for multiple platforms (iOS and Android).
* [Stack Wallet](https://stackwallet.com/) [\[code\]](https://github.com/cypherstack/stack_wallet) ⭐ 444 | 🐛 200 | 🌐 Dart | 📅 2026-08-21 - Multicoin wallet with UTXO (coin) control.
...
* 🔵 [Paytaca](https://www.paytaca.com/) [\[apk\]](https://github.com/paytaca/paytaca-app/releases) ⭐ 57 | 🐛 5 | 🌐 Vue | 📅 2026-08-20 [\[code\]](https://github.com/paytaca/paytaca-app) ⭐ 57 | 🐛 5 | 🌐 Vue | 📅 2026-08-20 - A mobile wallet for Android, iOS and ChromeOS
* 🔵 [Cashonize](https://github.com/cashonize/cashonize-wallet/tags) ⭐ 18 | 🐛 83 | 🌐 TypeScript | 📅 2026-08-20 [\[code\]](https://github.com/cashonize/cashonize-wallet) ⭐ 18 | 🐛 83 | 🌐 TypeScript | 📅 2026-08-20 - Offering an Android wallet for CashTokens.
...
* [Coin Wallet](https://coin.space/) [\[code\]](https://github.com/CoinSpace/CoinSpace) ⭐ 459 | 🐛 21 | 🌐 Vue | 📅 2026-08-20 - A self-custodial multicurrency wallet for multiple platforms (Windows, macOS and Linux).
...
* 🔵 [Cashonize (quasar)](https://github.com/cashonize/cashonize-wallet/tags) ⭐ 18 | 🐛 83 | 🌐 TypeScript | 📅 2026-08-20 [\[code\]](https://github.com/cashonize/cashonize-wallet) ⭐ 18 | 🐛 83 | 🌐 TypeScript | 📅 2026-08-20 - Cashonize rewrite with Quasar & Vue-js
...
* [Coin Wallet](https://coin.space/) [\[code\]](https://github.com/CoinSpace/CoinSpace) ⭐ 459 | 🐛 21 | 🌐 Vue | 📅 2026-08-20 - A self-custodial multicurrency wallet for multiple platforms (Web and Tor).
* 🔵 [Cashonize](https://cashonize.com/) [\[code\]](https://github.com/cashonize/cashonize-wallet) ⭐ 18 | 🐛 83 | 🌐 TypeScript | 📅 2026-08-20 -  An experimental web wallet for CashTokens.
...
* [Stamps](https://stamps.cash/#/) [\[code\]](https://github.com/harvmaster/CashStamps) ⭐ 6 | 🐛 3 | 🌐 Vue | 📅 2026-08-21 - Create reclaimable BCH wallets
...
* [BasicSwapdex](https://basicswapdex.com) [\[code\]](https://github.com/basicswap/basicswap) ⭐ 322 | 🐛 62 | 🌐 Python | 📅 2026-08-18 - Atomic swap DEX with BitcoinCash support
...
* 🔵 [Paytaca](https://www.paytaca.com/) [\[apk\]](https://github.com/paytaca/paytaca-app/releases) ⭐ 57 | 🐛 5 | 🌐 Vue | 📅 2026-08-20 [\[code\]](https://github.com/paytaca/paytaca-app) ⭐ 57 | 🐛 5 | 🌐 Vue | 📅 2026-08-20 - A mobile wallet with integrated POS.
...
* [Payment Requests Specification (BIP-0070)](https://github.com/bitcoin/bips/blob/master/bip-0070.mediawiki) ⭐ 10,923 | 🐛 50 | 🌐 Wikitext | 📅 2026-08-20 - For dealing with invoice style payments at specific amounts.
...
* 🔵 [Cashscript](https://cashscript.org/docs/basics/about/) [\[code\]](https://github.com/Bitcoin-com/cashscript) ⭐ 134 | 🐛 67 | 🌐 TypeScript | 📅 2026-08-20 [\[playground\]](https://playground.cashscript.org/) - a solidity-style language that compiles to Bitcoin Cash Script.
...
* [Examples in documentation](https://cashscript.org/docs/language/examples) and [examples in the CashScript github](https://github.com/CashScript/cashscript/tree/master/examples) ⭐ 134 | 🐛 67 | 🌐 TypeScript | 📅 2026-08-20.
...
* 🔵 [Knuth](https://kth.cash/) [\[code\]](https://github.com/k-nuth/kth) ⭐ 6 | 🐛 138 | 🌐 C++ | 📅 2026-08-20 - a high performance implementation of the Bitcoin protocol focused on applications needing extra capacity and resilience.
...
* 🔵 [Fulcrum](https://fulcrumserver.org) [\[repos\]](https://github.com/cculianu/Fulcrum/) ⭐ 492 | 🐛 64 | 🌐 C++ | 📅 2026-08-20 - A fast & nimble SPV Server for Bitcoin Cash.
