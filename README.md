...
* [Cake Wallet](https://cakewallet.com/) [\[code\]](https://github.com/cake-tech/cake_wallet) ⭐ 1,926 | 🐛 349 | 🌐 Dart | 📅 2026-09-22 [\[apk\]](https://github.com/cake-tech/cake_wallet/releases) ⭐ 1,926 | 🐛 349 | 🌐 Dart | 📅 2026-09-22 - An open source wallet for iOS and Android supporting XMR and other currencies.
* [Stack Wallet](https://stackwallet.com/) [\[code\]](https://github.com/cypherstack/stack_wallet) ⭐ 460 | 🐛 197 | 🌐 Dart | 📅 2026-09-22 - Multicoin wallet with UTXO (coin) control.
...
* 🔵 [Electron-Cash](https://electroncash.org) - Android [\[code\]](https://github.com/Electron-Cash/Electron-Cash/tree/master/android) ⭐ 389 | 🐛 441 | 🌐 Python | 📅 2026-09-22 and iOS [\[code\]](https://github.com/Electron-Cash/Electron-Cash/tree/master/ios) ⭐ 389 | 🐛 441 | 🌐 Python | 📅 2026-09-22 versions available with more limited functionality.
* 🔵 [Paytaca](https://www.paytaca.com/) [\[apk\]](https://github.com/paytaca/paytaca-app/releases) ⭐ 57 | 🐛 8 | 🌐 Vue | 📅 2026-09-23 [\[code\]](https://github.com/paytaca/paytaca-app) ⭐ 57 | 🐛 8 | 🌐 Vue | 📅 2026-09-23 - A mobile wallet for Android, iOS and ChromeOS
* 🔵 [Cashonize](https://github.com/cashonize/cashonize-wallet/tags) ⭐ 21 | 🐛 94 | 🌐 TypeScript | 📅 2026-09-22 [\[code\]](https://github.com/cashonize/cashonize-wallet) ⭐ 21 | 🐛 94 | 🌐 TypeScript | 📅 2026-09-22 - Offering an Android wallet for CashTokens.
...
* 🔵 [Electron Cash CashToken](https://electroncash.org) [\[release\]](https://github.com/Electron-Cash/Electron-Cash/releases/tag/4.3.0) ⭐ 389 | 🐛 441 | 🌐 Python | 📅 2026-09-22 [\[code\]](https://github.com/Electron-Cash/Electron-Cash/) ⭐ 389 | 🐛 441 | 🌐 Python | 📅 2026-09-22 - Electron Cash with CashTokens.
* 🔵 [Cashonize (quasar)](https://github.com/cashonize/cashonize-wallet/tags) ⭐ 21 | 🐛 94 | 🌐 TypeScript | 📅 2026-09-22 [\[code\]](https://github.com/cashonize/cashonize-wallet) ⭐ 21 | 🐛 94 | 🌐 TypeScript | 📅 2026-09-22 - Cashonize rewrite with Quasar & Vue-js
...
* [Javascript/Libauth](https://github.com/fyookball/js-libauth-integration-plugin) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-22 - JS and Libauth Integration plugin for Electron Cash ⚠️ Experimental ⚠️
...
* 🔵 [Cashonize](https://cashonize.com/) [\[code\]](https://github.com/cashonize/cashonize-wallet) ⭐ 21 | 🐛 94 | 🌐 TypeScript | 📅 2026-09-22 -  An experimental web wallet for CashTokens.
...
* [Stamps](https://stamps.cash/#/) [\[code\]](https://github.com/harvmaster/CashStamps) ⭐ 6 | 🐛 3 | 🌐 Vue | 📅 2026-09-23 - Create reclaimable BCH wallets
...
* 🔵 [OpenTokenRegistry](https://otr.cash/) [\[code\]](https://github.com/OpenTokenRegistry/otr.cash) ⭐ 15 | 🐛 9 | 🌐 JavaScript | 📅 2024-09-04 - Community-Verified Token Information
...
* 🔵 [Paytaca](https://www.paytaca.com/) [\[apk\]](https://github.com/paytaca/paytaca-app/releases) ⭐ 57 | 🐛 8 | 🌐 Vue | 📅 2026-09-23 [\[code\]](https://github.com/paytaca/paytaca-app) ⭐ 57 | 🐛 8 | 🌐 Vue | 📅 2026-09-23 - A mobile wallet with integrated POS.
...
* [Payment Requests Specification (BIP-0070)](https://github.com/bitcoin/bips/blob/master/bip-0070.mediawiki) ⭐ 10,952 | 🐛 56 | 🌐 Wikitext | 📅 2026-09-22 - For dealing with invoice style payments at specific amounts.
