...
* [Cake Wallet](https://cakewallet.com/) [\[code\]](https://github.com/cake-tech/cake_wallet) ⭐ 1,895 | 🐛 330 | 🌐 Dart | 📅 2026-09-02 [\[apk\]](https://github.com/cake-tech/cake_wallet/releases) ⭐ 1,895 | 🐛 330 | 🌐 Dart | 📅 2026-09-02 - An open source wallet for iOS and Android supporting XMR and other currencies.
* [Coin Wallet](https://coin.space/) [\[code\]](https://github.com/CoinSpace/CoinSpace) ⭐ 458 | 🐛 21 | 🌐 Vue | 📅 2026-09-02 - A self-custodial multicurrency wallet for multiple platforms (iOS and Android).
* [Stack Wallet](https://stackwallet.com/) [\[code\]](https://github.com/cypherstack/stack_wallet) ⭐ 456 | 🐛 198 | 🌐 Dart | 📅 2026-09-02 - Multicoin wallet with UTXO (coin) control.
...
* 🔵 [Paytaca](https://www.paytaca.com/) [\[apk\]](https://github.com/paytaca/paytaca-app/releases) ⭐ 57 | 🐛 7 | 🌐 Vue | 📅 2026-09-03 [\[code\]](https://github.com/paytaca/paytaca-app) ⭐ 57 | 🐛 7 | 🌐 Vue | 📅 2026-09-03 - A mobile wallet for Android, iOS and ChromeOS
* 🔵 [Cashonize](https://github.com/cashonize/cashonize-wallet/tags) ⭐ 18 | 🐛 86 | 🌐 TypeScript | 📅 2026-09-02 [\[code\]](https://github.com/cashonize/cashonize-wallet) ⭐ 18 | 🐛 86 | 🌐 TypeScript | 📅 2026-09-02 - Offering an Android wallet for CashTokens.
...
* [Coin Wallet](https://coin.space/) [\[code\]](https://github.com/CoinSpace/CoinSpace) ⭐ 458 | 🐛 21 | 🌐 Vue | 📅 2026-09-02 - A self-custodial multicurrency wallet for multiple platforms (Windows, macOS and Linux).
...
* 🔵 [Cashonize (quasar)](https://github.com/cashonize/cashonize-wallet/tags) ⭐ 18 | 🐛 86 | 🌐 TypeScript | 📅 2026-09-02 [\[code\]](https://github.com/cashonize/cashonize-wallet) ⭐ 18 | 🐛 86 | 🌐 TypeScript | 📅 2026-09-02 - Cashonize rewrite with Quasar & Vue-js
...
* [Coin Wallet](https://coin.space/) [\[code\]](https://github.com/CoinSpace/CoinSpace) ⭐ 458 | 🐛 21 | 🌐 Vue | 📅 2026-09-02 - A self-custodial multicurrency wallet for multiple platforms (Web and Tor).
* 🔵 [Cashonize](https://cashonize.com/) [\[code\]](https://github.com/cashonize/cashonize-wallet) ⭐ 18 | 🐛 86 | 🌐 TypeScript | 📅 2026-09-02 -  An experimental web wallet for CashTokens.
...
* [BasicSwapdex](https://basicswapdex.com) [\[code\]](https://github.com/basicswap/basicswap) ⭐ 323 | 🐛 65 | 🌐 Python | 📅 2026-08-28 - Atomic swap DEX with BitcoinCash support
...
* 🔵 [Paytaca](https://www.paytaca.com/) [\[apk\]](https://github.com/paytaca/paytaca-app/releases) ⭐ 57 | 🐛 7 | 🌐 Vue | 📅 2026-09-03 [\[code\]](https://github.com/paytaca/paytaca-app) ⭐ 57 | 🐛 7 | 🌐 Vue | 📅 2026-09-03 - A mobile wallet with integrated POS.
...
* [Payment Requests Specification (BIP-0070)](https://github.com/bitcoin/bips/blob/master/bip-0070.mediawiki) ⭐ 10,936 | 🐛 56 | 🌐 Wikitext | 📅 2026-09-01 - For dealing with invoice style payments at specific amounts.
...
* 🔵 [Cashscript](https://cashscript.org/docs/basics/about/) [\[code\]](https://github.com/Bitcoin-com/cashscript) ⭐ 134 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-01 [\[playground\]](https://playground.cashscript.org/) - a solidity-style language that compiles to Bitcoin Cash Script.
...
* [Examples in documentation](https://cashscript.org/docs/language/examples) and [examples in the CashScript github](https://github.com/CashScript/cashscript/tree/master/examples) ⭐ 134 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-01.
...
* 🔵 [Fulcrum](https://fulcrumserver.org) [\[repos\]](https://github.com/cculianu/Fulcrum/) ⭐ 495 | 🐛 64 | 🌐 C++ | 📅 2026-08-20 - A fast & nimble SPV Server for Bitcoin Cash.
