...
* [Cake Wallet](https://cakewallet.com/) [\[code\]](https://github.com/cake-tech/cake_wallet) ⭐ 1,860 | 🐛 317 | 🌐 Dart | 📅 2026-08-20 [\[apk\]](https://github.com/cake-tech/cake_wallet/releases) ⭐ 1,860 | 🐛 317 | 🌐 Dart | 📅 2026-08-20 - An open source wallet for iOS and Android supporting XMR and other currencies.
...
* [Stack Wallet](https://stackwallet.com/) [\[code\]](https://github.com/cypherstack/stack_wallet) ⭐ 441 | 🐛 203 | 🌐 Dart | 📅 2026-08-20 - Multicoin wallet with UTXO (coin) control.
...
* 🔵 [Cashonize](https://github.com/cashonize/cashonize-wallet/tags) ⭐ 18 | 🐛 85 | 🌐 TypeScript | 📅 2026-08-19 [\[code\]](https://github.com/cashonize/cashonize-wallet) ⭐ 18 | 🐛 85 | 🌐 TypeScript | 📅 2026-08-19 - Offering an Android wallet for CashTokens.
...
* 🔵 [Cashonize (quasar)](https://github.com/cashonize/cashonize-wallet/tags) ⭐ 18 | 🐛 85 | 🌐 TypeScript | 📅 2026-08-19 [\[code\]](https://github.com/cashonize/cashonize-wallet) ⭐ 18 | 🐛 85 | 🌐 TypeScript | 📅 2026-08-19 - Cashonize rewrite with Quasar & Vue-js
...
* 🔵 [Cashonize](https://cashonize.com/) [\[code\]](https://github.com/cashonize/cashonize-wallet) ⭐ 18 | 🐛 85 | 🌐 TypeScript | 📅 2026-08-19 -  An experimental web wallet for CashTokens.
...
* [Payment Requests Specification (BIP-0070)](https://github.com/bitcoin/bips/blob/master/bip-0070.mediawiki) ⭐ 10,922 | 🐛 52 | 🌐 Wikitext | 📅 2026-08-19 - For dealing with invoice style payments at specific amounts.
...
* 🔵 [Knuth](https://kth.cash/) [\[code\]](https://github.com/k-nuth/kth) ⭐ 6 | 🐛 135 | 🌐 C++ | 📅 2026-08-19 - a high performance implementation of the Bitcoin protocol focused on applications needing extra capacity and resilience.
